...
CREATE TABLE IF NOT EXISTS role(
    ...
    role_type VARCHAR(50) NOT NULL CHECK ( role_type IN('ROLE_USER', 'ROLE_OWNER', 'ROLE_ADMIN') ) DEFAULT 'ROLE_USER'
);
...
INSERT INTO role(role_type) VALUES ('ROLE_USER'), ('ROLE_OWNER'), ('ROLE_ADMIN');